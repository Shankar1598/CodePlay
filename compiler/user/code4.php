		...
		<title>Online Compiler for Off-Campus Students</title>
			...
			window.addEventListener('blur', function() {
				...
				$(document).ready(function() { 
					...
					if(width>=100){
						clearInterval(intr);
						save(alert('Running Out of time'));
...
<div class="footer">
	<a href="code3.php" onclick="saveop();"><button class="btn fl" id="backbtn">Back</button></a>
...
<div class="ques">
	<table>
		<tbody>
			<tr>
				<td>
<strong>Problem 4</strong><br><br>
Given a number system with only 3 and 4.<br><br> Find the nth number in the number system.<br><br>
First few numbers in the number system are: 3, 4, 33, 34, 43, 44, 333, 334, 343, 344, 433, 434, 443, 444, 3333, 3334, 3343, 3344, 3433, 3434, 3443, 3444, …<br><br>
<b>Input:</b> <br><br>
Integer value , 1<=a<=10000000<br><br>
<b>Output:</b> <br><br>
Nth number in the number system.<br><br>
<b>Sample1:</b> <br><br>
<b>Input:</b> 3 <br><br>
<b>Output:</b> 33 <br><br>
